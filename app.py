...
with tab_money:
    ...
    with st.expander("💳  Weekly Payment Grid", expanded=True):
        st.caption("Tick or untick payments directly in the weekly grid. This is the fastest way to record or undo several payments.")
